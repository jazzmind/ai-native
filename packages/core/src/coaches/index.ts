export type { AgentMode } from '../modes/index';
...
/**
 * Static metadata about an advisor — no runtime agent IDs.
 * AgentProvider implementations resolve their own runtime IDs.
 */
...
export const COACH_META: CoachMeta[] = [
  ...
  },
  {
    key: "mk",
    name: "MK Coach",
    description: "Personal knowledge practices: readiness, enoughness, ignorance, wisdom",
    icon: "BookOpen",
    keywords: ["knowledge", "readiness", "enough", "research", "ignorance", "wisdom", "decide", "how much to know", "analysis paralysis", "research loop", "manage knowledgement", "what should I know", "am I ready"],
  },
];
...
export function getCoachByKey(key: string): CoachMeta | undefined {
  return getCoachMeta(key);
}
