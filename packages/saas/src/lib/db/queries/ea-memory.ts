...
import { type EaMemoryType, EA_MEMORY_TYPES as _EA_MEMORY_TYPES } from '@ai-native/core';

// Re-export from core so existing imports of EaMemoryType from this module still work
export type { EaMemoryType };
